...
{
    public partial class JobPositionAndUsers : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PositionsAvailable = table.Column<int>(type: "INTEGER", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_JobPositions_Careers_CareerId",
                        column: x => x.CareerId,
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "02174cf0–9412–4cfe-afbf-59f706d72cf6", 0, false, "3ffdad97-a459-451a-856e-5366187c97c5", "Admin", "administracion@frro.utn.edu.ar", true, false, "Administracion", "Utn", false, null, "ADMINISTRACION@FRRO.UTN.EDU.AR", null, "AQAAAAEAACcQAAAAEAOauAGiTTMueTXM2Sm4ZfBTbLlUJIh6l3ObfVy9Ss0rD9ukb5Hb+Mv8+OI/q6Yo6w==", null, false, "0160fd9f-02b7-4edc-9c83-d7f418fbc14e", false, null });
